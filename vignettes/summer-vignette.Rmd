...
data_multi <- countrySummary_mult(births = DemoData, years = years, idVar = "id", regionVar = "region",
...
```{r}
plot(out4, is.yearly=TRUE, is.subnational=TRUE,  data.add = data_multi, option.add = list(point = "u5m", by = "surveyYears")) + ggplot2::ggtitle("Subnational yearly model") + facet_wrap(~region) 
