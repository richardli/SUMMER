...
#' Census. General population counts are estimated for 2014. Also contains 2014 population density 
...
#' The dataset names are: easpaKenya, easpaKenyaNeonatal, popMatKenya, popMatKenyaNeonatal, 
